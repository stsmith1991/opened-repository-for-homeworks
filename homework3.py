...
f = str(input('Введите проверяемое выражение. Можно и не вводить. Есть дефолтное: '))
o = ' '.join(capitalize_lat(f))
print(f'Вы ввели: {f}\nМы получили: {o}\nНа этом и закончим.')
# рекомендуемая фраза:
# you dоn`t do it this time because of you is great nооb
